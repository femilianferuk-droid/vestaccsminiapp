        ...
        (function () {
            ...
            function renderChatMessages() {
                ...
                for (const m of msgs) {
                    ...
                    div.innerHTML = `${safe}<span class="chat-bubble-time">${escapeHtml(formatChatBubbleTime(m.created_at))}</span>`;
            ...
            // Запуск периодического опроса счётчика непрочитанных (раз в 12 секунд).
            // Не делаем это слишком часто, чтобы не давить БД.
