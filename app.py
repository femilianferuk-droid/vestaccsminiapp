...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        /* Бейдж страны — спокойный серо-голубой, не перетягивает
           внимание от верификации/даты регистрации, но и не теряется. */
            ...
            */
            ...
            function renderCatalog() {
                ...
                state.catalog.forEach((it) => {
                    ...
                    // Страна — характеристика, идёт ПОСЛЕ даты регистрации,
                    // как и просили. Без эмодзи-флага (флаг убран из карточки).
                    if (it.country) {
                        metaBadges.push(
                            `<span class="card-meta-badge country" title="Страна выпуска аккаунта">` +
                            `<svg viewBox="0 0 16 16" width="11" height="11" aria-hidden="true">` +
                            `<path fill="currentColor" d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 1.4c1.7 0 3.2 1.4 4.1 3.6H3.9C4.8 2.8 6.3 1.4 8 1.4zM1.4 8c0-.6.1-1.1.2-1.6h2.1c-.1.5-.1 1-.1 1.6s0 1.1.1 1.6H1.6c-.1-.5-.2-1-.2-1.6zm6.6 6.6c-1.7 0-3.2-1.4-4.1-3.6h8.2c-.9 2.2-2.4 3.6-4.1 3.6zM12.3 9.6c.1-.5.1-1 .1-1.6s0-1.1-.1-1.6h2.1c.1.5.2 1 .2 1.6s-.1 1.1-.2 1.6h-2.1z"/>` +
                            `</svg>${escapeHtml(it.country)}</span>`
                        );
                    }
