    ...
    <div class="page" id="pageSell">
        ...
        <div class="sell-form-card" id="sellStep2" style="display:none;">
            ...
            <div id="sellCodeWrap" style="display:none; margin-top: 18px;">
                ...
                <div class="sell-hint">Код придёт в Telegram на указанный номер. Введите его и нажмите «Подтвердить».</div>
            ...
            */
            ...
            async function submitSellCode() {
                ...
                if (!code || code.length < 4) {
                    showStep2Error('Введите код подтверждения (минимум 4 цифры)');
                    return;
                }
                showStep2Error('');
            ...
            function bindSellEvents() {
                ...
                if (codeInput) {
                    codeInput.addEventListener('keydown', (e) => {
                        if (e.key === 'Enter') {
                            e.preventDefault();
                            // Только если длина >= 4 — ручная отправка
