...
<head>
    ...
    <title>VestAccPunt — Маркетплейс</title>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        body {
            ...
            background-image:
                ...
                radial-gradient(circle at 100% 0%, rgba(168, 85, 247, 0.05), transparent 45%);
        ...
        .hero-title {
            ...
            color: var(--blue-900); letter-spacing: -0.6px; line-height: 1.08;
        }
        .hero-title span {
    ...
    <div class="page" id="pageProfile">
        ...
        <div class="balance-card">
            <div class="balance-card-label">
                <span><span class="sync-dot"></span>Баланс в общей БД</span>
                <span id="balanceSyncedAt">только что</span>
            </div>
    ...
    <script>
        (function () {
            ...
            function setBalanceUI(value, extra) {
                ...
                if (extra && extra.syncedAt) {
                    state.lastBalanceSync = extra.syncedAt;
                    dom.balanceSyncedAt.textContent = humanizeSync(extra.syncedAt);
                } else {
                    dom.balanceSyncedAt.textContent = 'только что';
                }
            }

            function humanizeSync(iso) {
