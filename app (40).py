  ...
  loadProfileListings();
            ...
            */
            ...
            function renderCategoryChrome() {
                ...
                const isAccounts = state.category === 'accounts';
            ...
            function renderCategoryFilters() {
                ...
                dom.categoryFilterLabel.textContent = info.filterLabel || 'Параметры категории';
                dom.categoryFilterGrid.innerHTML = '';
                (info.filters || ['all']).forEach((value) => {
